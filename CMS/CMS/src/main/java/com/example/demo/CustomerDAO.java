...
public class CustomerDAO {
    ...
    public String getMailId(int cus_id) {
    	String cmd=" select cus_email from customer where cus_id = ?";
    	 List str=jdbc.query(cmd,new Object[] {cus_id}, new RowMapper() {
             @Override
             public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                 // TODO Auto-generated method stub
                 return rs.getString("cus_email");
             }
